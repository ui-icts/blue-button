...
<table class="table table-bordered table-striped table-hover table-datatable">
    ...
    <tbody>
        <c:forEach items="${ clinicalDocumentList }" var="clinicalDocument"  varStatus="status">
            <tr>
                <td><a href="edit?clinicalDocumentId=${clinicalDocument.clinicalDocumentId}">${clinicalDocument.clinicalDocumentId}</a></td>
                ...
                <td>${clinicalDocument.source}</td>
                <td>${clinicalDocument.parsedJson}</td>
                <td>${clinicalDocument.jsonParserVersion}</td>
